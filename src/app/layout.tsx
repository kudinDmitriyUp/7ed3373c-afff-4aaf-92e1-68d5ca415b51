...
export const metadata: Metadata = {
  title: "Webild - AI-Powered Website Builder",
  description: "Create professional websites instantly with Webild's AI technology. No coding required. Launch in minutes with automated design, hosting, and analytics.",
  keywords: "AI website builder, ChatGPT for websites, website generator, no code, website creation",
  ...
  openGraph: {
    title: "Webild - AI-Powered Website Builder",
    description: "Create professional websites instantly with Webild's AI technology. No coding required.",
    siteName: "Webild",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764873999210-lds3t1fj.jpg",
        alt: "Webild AI website builder interface"
      }
    ]
  },
  twitter: {
    ...
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764873999210-lds3t1fj.jpg"]
  },
  robots: {
    index: true,
    follow: true
